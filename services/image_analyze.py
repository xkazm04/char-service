...
PROMPT_TEMPLATE = (
    ...
    "- 'gen': A structured prompt optimized for image generation tools. Format as: '[MAIN_SUBJECT], [STYLE_DESCRIPTORS], [MATERIAL_TEXTURE], [LIGHTING_MOOD]'. Use complete phrases and descriptive language that AI image generators understand well.\n"
    ...
    "- 'style_tags': An array of 3-5 specific style keywords that can be used for consistent generation (e.g., ['fantasy', 'medieval', 'ornate', 'leather-bound']).\n"
    "- 'combination_weight': A number from 1-10 indicating how prominent this asset should be when combined with others (10 = primary focus, 1 = subtle detail).\n\n"
    "GEN FIELD GUIDELINES:\n"
    "- Use natural, descriptive language that image AI understands\n"
    "- Structure: [Main item description], [detailed visual style], [material and texture details], [lighting and mood]\n"
    "- Avoid simple comma lists - use descriptive phrases\n"
    "- Include specific colors, materials, and artistic styles\n"
    "- Consider how this asset would look in isolation for generation\n\n"
    "EXAMPLE RESPONSE FORMAT:\n"
    "[\n"
    "  {\n"
    "    \"description\": \"Elegant dark red silk necktie with subtle pattern\",\n"
    "    \"gen\": \"elegant dark crimson silk necktie with subtle geometric pattern, professional business style, smooth lustrous silk texture, studio lighting with soft shadows\",\n"
    "    \"type\": \"Clothing\",\n"
    "    \"subcategory\": \"Accessories\",\n"
    "    \"name\": \"Crimson Silk Tie\",\n"
    "    \"style_tags\": [\"formal\", \"business\", \"elegant\", \"silk\"],\n"
    "    \"combination_weight\": 3\n"
    "  },\n"
    "  {\n"
    "    \"description\": \"Tailored navy blue wool suit jacket with notched lapels\",\n"
    "    \"gen\": \"tailored navy blue wool suit jacket with sharp notched lapels, modern professional cut, fine wool texture with subtle weave pattern, soft natural lighting\",\n"
    "    \"type\": \"Clothing\",\n"
    "    \"subcategory\": \"Upper Wear\",\n"
    "    \"name\": \"Navy Wool Blazer\",\n"
    "    \"style_tags\": [\"formal\", \"tailored\", \"professional\", \"wool\"],\n"
    "    \"combination_weight\": 8\n"
    "  },\n"
    "  {\n"
    "    \"description\": \"Ornate silver fantasy sword with runic engravings\",\n"
    "    \"gen\": \"ornate silver longsword with intricate runic engravings along the blade, fantasy medieval design, polished steel with etched magical symbols, dramatic lighting with gleaming highlights\",\n"
    "    \"type\": \"Equipment\",\n"
    "    \"subcategory\": \"Weapons\",\n"
    "    \"name\": \"Runic Silver Blade\",\n"
    "    \"style_tags\": [\"fantasy\", \"medieval\", \"ornate\", \"runic\", \"silver\"],\n"
    "    \"combination_weight\": 9\n"
    "  }\n"
    "]\n\n"
